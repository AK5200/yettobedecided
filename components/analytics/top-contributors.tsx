    ...
    <div className="bg-gradient-to-br from-white to-gray-50 rounded-2xl shadow-lg border border-border p-6 h-full flex flex-col">
      ...
      {users.length === 0 ? (
        <div className="text-center py-12 text-muted-foreground">
          ...
          <p className="text-xs text-muted-foreground/60 mt-1">Users will appear here as they engage</p>
        </div>
      ) : (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-4 mt-1.5">
                    ...
                    <div className="flex items-center gap-1.5 text-xs text-muted-foreground">
                      <span className="font-semibold text-foreground">{user.vote_count}</span>
                      <span>votes</span>
                    </div>
                  </div>
                </div>
