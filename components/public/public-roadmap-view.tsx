  ...
  return (
    <div className="min-h-screen bg-muted/50">
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        {/* Page header */}
        <div className="mb-8">
          <h1 className="text-2xl font-bold text-foreground tracking-tight">Roadmap</h1>
        ...
        {totalPosts === 0 ? (
          <div className="text-center py-16">
            ...
            <p className="text-sm font-medium text-foreground">Roadmap is empty</p>
              ...
              <div key={column.key} className="flex flex-col">
                ...
                <div className="space-y-3 flex-1">
                  {column.posts.length === 0 ? (
                    <div className="bg-background border border-dashed border-border rounded-xl py-8 text-center">
                      <p className="text-xs text-muted-foreground/60">No items</p>
                    </div>
                  ) : (
                    column.posts.map((post) => (
                      <PostDetailDialog key={post.id} post={post}>
                        <div className="group bg-card p-5 rounded-2xl border border-border shadow-sm hover:shadow-md hover:border-yellow-300/50 transition-all cursor-pointer">
                          <h3 className="text-sm font-bold text-foreground mb-2 group-hover:text-yellow-600 transition-colors">
                            {post.title}
                          </h3>
                          ...
                          <div className="flex items-center gap-3">
                            <div className="flex items-center gap-1 text-muted-foreground/60 group-hover:text-yellow-500 transition-colors">
