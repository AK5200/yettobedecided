...
export function ChangelogPopup({
  ...
  return (
    ...
    >
      {/* Header */}
      <div className="px-6 pt-6 pb-4 border-b dark:border-white/10 shrink-0 bg-white dark:bg-[#1a1a1a]" style={{ backgroundColor: headerBackgroundColor || backgroundColor || undefined }}>
