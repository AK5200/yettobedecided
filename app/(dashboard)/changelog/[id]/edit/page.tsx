  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#0a0a0a]">
      <div className="max-w-5xl mx-auto p-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Edit Changelog Entry</h1>
          <p className="text-gray-600 dark:text-white/50">Update your changelog entry</p>
        </div>
